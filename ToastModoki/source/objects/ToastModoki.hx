...
class ToastModoki extends openfl.display.Sprite {
	public var onFinish:Void->Void = null;
	var alphaTween:FlxTween;
	var lastScale:Float = 1;
	public function new(achieve:String, achiName:String, achiDesc:String, onFinish:Void->Void)
	{
		super();

		// bg
		graphics.beginFill(FlxColor.BLACK);
		graphics.drawRoundRect(800, 0, 420, 130, 16, 16); // ASMIE (X POS) * Change BOTH if you want

		// achievement icon
		var graphic = null;
		var hasAntialias:Bool = ClientPrefs.data.antialiasing;
		var image:String = 'toastmodoki/$achieve';
		...
		var imgX = 815; // ASMIE (X POS) * Change BOTH if you want
		var imgY = 15;
		...
		*/
		...
		text.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, LEFT); // ASMIE (FONT)
	...
	/*
	public static function startPopup(achieve:String, achiName:String, achiDesc:String, endFunc:Void->Void = null) {
